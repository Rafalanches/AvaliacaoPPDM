  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Cadastro de Médicos'), // Título da AppBar
      ),
  ...
  _showTaskDialog() async {
    ...
    await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Novo Médico'), // Título do diálogo
        content: Column(
          // Conteúdo do diálogo
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                  labelText: 'Nome do Médico'), // Decoração do campo de texto
            ),
            TextField(
              ...
              decoration: InputDecoration(
                  labelText: 'Especialidade do Médico'), // Decoração do campo de texto
            ),
          ],
        ),
        actions: [
